...
2. Inclus dans chaque item du résultat les champs: title, publisher, timestamp, link, sentiment, score, impact, et **text_excerpt**.
3. Basé sur les résultats, calcule un biais global : bullish / bearish / neutral.
4. Retourne JSON (summary, global_bias, data).
"""
