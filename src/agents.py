...
async def run_data_mcp(params: dict) -> dict:
    data_mcp_path = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "mcp/data_fetch/yf_mcp.py")
    )
        ...
        async with ClientSession(read, write) as session:
            ...
            prompt = await load_mcp_prompt(
                ...
                arguments={
                    ...
                    "news_top_n": str(params.get("news_top_n", 20)),
                    "include_columns": params.get("include_columns", "Open,High,Low,Close,Volume"),
                },
            )
